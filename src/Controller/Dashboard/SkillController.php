...
use App\Services\Dashboard\SkillServicesInterface;
...
class SkillController extends AbstractController
{
    ...
    {
        return $this->render('dashboard/skill/index.html.twig', $this->service->index());
    }
    ...
    {
        return $this->render('dashboard/skill/edit.html.twig', $this->service->edit($skill));
    }
