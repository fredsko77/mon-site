...
class ProjectServices implements ProjectServicesInterface
{
    ...
    public function create(Request $request): object
    {
        ...
        return $this->sendJson(
            ...
            [
                'Location' => $this->router->generate('dashboard_project_edit', [
                    'id' => $project->getId(),
    ...
    public function createTask(Project $project, Request $request): object
    {
        ...
        return $this->sendJson(
            ...
            Response::HTTP_CREATED,
            [
                'Task-Link' => $this->router->generate('dashboard_project_task_edit', [
                    'id' => $task->getId(),
                ]),
            ]
        );
        ...
        if ($file instanceof UploadedFile) {
            ...
            if ($upload instanceof ProjectImage) {
                ...
                return $this->sendJson(
                    ...
                    Response::HTTP_CREATED,
                    [
                        'Project-Link' => $this->router->generate('dashboard_project_image_edit', [
                            'id' => $upload->getId() ?? 1,
                        ], UrlGenerator::ABSOLUTE_URL),
                    ]
                );
